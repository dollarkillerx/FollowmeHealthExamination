...
func CurrentPosition(uid string, token string) (*models.CurrentPosition, error) {
	urli := fmt.Sprintf("https://www.followme.hk/api/v3/followtrade/agent/positions?uid=%s&index=13", uid)
